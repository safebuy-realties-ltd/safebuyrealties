...
and on the day it went out every cell in that table's **Answer recorded** column was empty. **One
item has answered since: ADR-0003, on 2026-08-07, in full, and it is closed.** It was accepted as
written by Adebiyi Emmanuel Babatope, Chief Operating Officer, and
[docs/adr/0003-payment-mock-mode-guard.md](adr/0003-payment-mock-mode-guard.md) now reads Accepted
rather than Proposed. **That closes an item and still moves no story**, because ADR-0003 ratifies
behaviour that shipped with E2-S4 on 2026-07-30 and no row in the table below was waiting on it.
The other ten cells are empty and the state of those ten rows is what it was before the schedule
went out. **It asks for a
