...
export const POA_CONSENT_ITEMS: Array<{
  ...
  },
  {
    ...
    label:
      "I acknowledge this PoA will require independent witnessing to be legally binding",
  },
  {
...
export const POA_INSTRUMENT_SECTIONS = [
  {
    title: "Appointment",
    body:
      "I hereby irrevocably appoint SafeBuyRealties as my true and lawful attorney-in-fact to act on my behalf in connection with the acquisition and perfection of title to the property described in this transaction.",
  },
  {
    title: "Scope of Authority",
    body:
      "SafeBuyRealties is authorised to conduct due diligence and verification; process and perfect title documentation; apply for Governor's Consent and Certificate of Occupancy where applicable; pay statutory fees; receive, execute, and deliver documents; and take any ancillary steps reasonably required to complete the purchase.",
  },
  {
    title: "Revocation",
    body:
      "This Power of Attorney is irrevocable until completion of the transaction and registration of title in my name, or until released in writing by SafeBuyRealties following completion of all obligations under the transaction.",
  },
  {
    title: "Indemnity",
    body:
      "I agree to indemnify and hold harmless SafeBuyRealties, its officers, and agents against claims, losses, and expenses arising from actions taken in good faith pursuant to this instrument, except where caused by gross negligence or wilful misconduct.",
  },
  {
